...
def count_run_check():
    ...
    raw_count = db[URL_COLLECTION_NAME].count()
    fitlered_count = db[URL_META_COLLECTION_NAME].count()
    populate_raw_data()
    populate_filtered_data(USER_URL)
    print("Total raw data updated =", db[URL_COLLECTION_NAME].count()-raw_count)
    print("Total filtered data updated = ", db[URL_META_COLLECTION_NAME].count()-fitlered_count)
count_run_check()
# populate_filtered_data(USER_URL)
