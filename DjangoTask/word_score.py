...
def get_tf_idf(doc_list):
    ...
    tf_idf_list = []
    tf_list = get_tf_list(doc_list)
    df_dict = get_df_dict(doc_list)
    count = get_words_count(doc_list)
    for doc in tf_list:
        doc_dict = {}
